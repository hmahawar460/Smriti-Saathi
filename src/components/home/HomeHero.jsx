    ...
    <section className="relative pt-6 pb-12 sm:pb-16 bg-[#F8FAFC] overflow-hidden" id="hero">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5 mb-8 max-w-6xl">
          ...
          <div className="bg-gradient-to-r from-teal-50/90 via-emerald-50/50 to-teal-50/90 border border-teal-200/90 rounded-2xl p-3 sm:p-3.5 shadow-xs flex items-center justify-between gap-3 hover:border-[#0D7377] hover:shadow-sm transition group">
            <div className="flex items-center gap-2.5 min-w-0">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#0D7377] to-teal-800 flex items-center justify-center text-white shrink-0 shadow-xs group-hover:scale-105 transition-transform">
                <Camera className="w-5 h-5 text-[#9DF3C4]" />
              </div>
              <div className="min-w-0">
                <span className="text-[9px] sm:text-[10px] font-extrabold text-[#0D7377] tracking-wider uppercase block flex items-center gap-1">
            ...
            <button
              ...
              className="bg-gradient-to-r from-[#0D7377] to-teal-700 hover:from-[#0A5C5F] hover:to-teal-800 text-white px-2.5 sm:px-3 py-1.5 rounded-xl font-bold text-xs flex items-center gap-1 shrink-0 transition cursor-pointer shadow-xs active:scale-95 whitespace-nowrap"
            >
              <span>Gallery</span>
          ...
          <div className="bg-gradient-to-r from-slate-900 via-[#001A4C] to-[#0D7377] border border-slate-700/80 rounded-2xl p-3 sm:p-3.5 shadow-xs flex items-center justify-between gap-3 hover:border-[#9DF3C4] hover:shadow-sm transition group text-white">
            <div className="flex items-center gap-2.5 min-w-0">
              <div className="w-10 h-10 rounded-xl bg-white/10 backdrop-blur flex items-center justify-center text-white shrink-0 shadow-xs group-hover:scale-105 transition-transform border border-white/20">
                <Music className="w-5 h-5 text-[#9DF3C4]" />
              </div>
              <div className="min-w-0">
                <span className="text-[9px] sm:text-[10px] font-extrabold text-[#9DF3C4] tracking-wider uppercase block flex items-center gap-1">
                  <Sparkles className="w-3 h-3 text-[#9DF3C4]" />
                  NOSTALGIA & MUSIC
                </span>
            ...
            <button
              ...
              className="bg-[#9DF3C4] hover:bg-[#85E7B0] text-[#001A4C] px-2.5 sm:px-3 py-1.5 rounded-xl font-extrabold text-xs flex items-center gap-1 shrink-0 transition cursor-pointer shadow-xs active:scale-95 whitespace-nowrap"
            >
              <span>Explore</span>
              <span>✨</span>
            </button>
          ...
          <div className="xl:col-span-6 space-y-6 max-w-2xl mx-auto xl:mx-0">
            ...
            <div className="flex flex-wrap items-center gap-3.5 pt-2">
              <button
                ...
                className="btn-glow-teal px-8 py-4 sm:py-5 rounded-2xl bg-[#0D7377] hover:bg-[#0A5C5F] text-white font-black text-lg sm:text-xl flex items-center gap-3 transition shadow-xl cursor-pointer active:scale-95"
              >
