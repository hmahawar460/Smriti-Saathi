        ...
        <div className="cg-left">
          ...
          <div className="cg-note">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              ...
              <path d="M8 5v3M8 10.5h0" stroke="#2563EB" strokeWidth="2" strokeLinecap="round" />
            </svg>
          ...
          <div className="cg-mockup">
            ...
            <div className="cgm-chart-area">
              ...
              <svg viewBox="0 0 300 80" className="cgm-chart-svg">
                ...
                <path d="M0,60 Q50,45 100,50 T200,30 T300,18" fill="none" stroke="#2563EB" strokeWidth="2.5" />
