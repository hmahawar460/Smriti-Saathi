export const BrainBoostLogo = ({
  ...
  return <div className={`flex items-center gap-2.5 select-none ${className}`}>
    ...
    /* Brain Icon */
      ...
      <div className={`${iconSize} relative shrink-0 flex items-center justify-center`}>
        <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-xs">
          <defs>
            <linearGradient id="brainGrad" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#00D2C4" />
              <stop offset="60%" stopColor="#0D7377" />
              <stop offset="100%" stopColor="#1D7BF6" />
            </linearGradient>
    ...
    /* Brain Left Hemisphere */
          ...
          <path
    d="M48 20 C32 18, 18 28, 16 42 C14 54, 20 62, 22 70 C24 78, 34 85, 46 84 C48 84, 48 20, 48 20 Z"
    fill="url(#brainGrad)"
  />
          {
    /* Brain Right Hemisphere */
          ...
          <path
    d="M52 20 C68 18, 82 28, 84 42 C86 54, 80 62, 78 70 C76 78, 66 85, 54 84 C52 84, 52 20, 52 20 Z"
    fill="url(#brainGrad)"
  />
          {
    /* Inner gyri / convolutions */
  }
          <path
    d="M26 36 C34 32, 42 36, 46 42 M22 52 C32 50, 40 56, 46 62 M30 70 C38 68, 44 72, 46 76"
    fill="none"
    stroke="#E0F7FA"
    strokeWidth="3.5"
    strokeLinecap="round"
  />
          <path
    d="M74 36 C66 32, 58 36, 54 42 M78 52 C68 50, 60 56, 54 62 M70 70 C62 68, 56 72, 54 76"
    fill="none"
    stroke="#E0F7FA"
    strokeWidth="3.5"
    strokeLinecap="round"
  />
    ...
    /* Center dividing fissure */
          ...
          <line x1="50" y1="18" x2="50" y2="86" stroke="#0A4D50" strokeWidth="2.5" strokeLinecap="round" />
        </svg>
      </div>
    ...
    /* Brand Text */
      ...
      <div className="flex items-baseline tracking-tight font-black font-sans leading-none">
        <span className={`${textSize} text-[#0A2540] tracking-tight font-black`}>BRAIN</span>
        <span className={`${textSize} text-[#1D7BF6] tracking-tight font-black`}>BOOST</span>
      </div>
    </div>;
};
